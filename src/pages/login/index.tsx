            ...
            <div className='w-full max-w-2xl mx-auto min-h-screen sm:min-h-0 bg-[#E91E63] flex flex-col sm:rounded-[48px] overflow-hidden'>
                ...
                <div className='flex-1 flex flex-col items-center justify-center px-8 py-8 gap-4'>
                    ...
                    <p className='text-white/70 text-sm text-center'>
                        Continue de onde parou com seu par
                    </p>
                </div>
                ...
                <div className='bg-[#2B2B2B] px-6 py-8 flex flex-col gap-4'>
                    ...
                    icon={
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={email ? '#E91E63' : '#71717a'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    right={
                         <button type='button' onClick={() => setMostrarSenha(!mostrarSenha)} className='text-zinc-500 hover:text-zinc-300 transition-colors'>
                                {mostrarSenha ? (
                    ...
                    <div className='flex justify-end'>
                        <button className='text-[#E91E63] text-sm hover:underline'>
                            Esqueci minha senha
                        </button>
                    </div>

                    <Button onClick={fazerLogin} texto='Entrar' />
                    ...
                    <p className='text-zinc-500 text-sm text-center'>
                        Não tem conta?{' '}
                        <button className='text-[#E91E63] font-medium hover:underline' onClick={() => navigate({ to: '/signin' })}>
                            Criar conta
                        </button>
                    </p>
